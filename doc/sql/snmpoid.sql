...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('3cIfDescr','1.3.6.1.2.1.2.2.1.2','3Com ifDescr for port and unit','3com','0','.*(Unit|Port) (\d+)\b.*','1',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='3cIfMauType';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('3cIfMauType','1.3.6.1.2.1.26.2.1.1.3','Speed and dupelx for SWxx00','3com','0',NULL,'0',NULL,NULL);
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('3cPS40PortState','1.3.6.1.2.1.26.1.1.1.6','Port state for 3Com PS40','3com','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='3cSSMac';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('3cSSMac','1.3.6.1.4.1.43.10.22.2.1.3','Bridge table for 3Com SuperStack','3com','0',NULL,'0',NULL,NULL);
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('basePortIfIndex','1.3.6.1.2.1.17.1.4.1.2','Port ifindex mapping','bridge-mib','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='c1900Bandwidth';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('c1900Bandwidth','1.3.6.1.4.1.437.1.1.3.7.1.0','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='c1900BandwidthMax';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('c1900BandwidthMax','1.3.6.1.4.1.437.1.1.3.7.5.0','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='c1900Duplex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('c1900Duplex','1.3.6.1.4.1.437.1.1.3.3.1.1.8','Duplex status','Cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='c1900Portname';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('c1900Portname','1.3.6.1.4.1.437.1.1.3.3.1.1.3','Portname','Cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='c2900Bandwidth';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('c2900Bandwidth','1.3.6.1.4.1.9.9.87.1.5.1.0','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='c5000Bandwidth';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('c5000Bandwidth','1.3.6.1.4.1.9.5.1.1.8.0','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='c5000BandwidthMax';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('c5000BandwidthMax','1.3.6.1.4.1.9.5.1.1.19.0','','Cricket','0',NULL,'0',NULL,NULL);
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cCardDescr','1.3.6.1.4.1.9.3.6.11.1.3','Slot card description','Cisco','0',NULL,'0',NULL,'OLD-CISCO-CHASSIS-MIB');

DELETE FROM snmpoid WHERE oidkey='cCardHwVersion';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cCardHwVersion','1.3.6.1.4.1.9.3.6.11.1.5','Slot card hardware version','Cisco','0',NULL,'0',NULL,'OLD-CISCO-CHASSIS-MIB');

DELETE FROM snmpoid WHERE oidkey='cCardIndex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cCardIndex','1.3.6.1.4.1.9.3.6.11.1.1','Slot card type','Cisco','0',NULL,'0',NULL,'OLD-CISCO-CHASSIS-MIB');

DELETE FROM snmpoid WHERE oidkey='cCardSerial';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cCardSerial','1.3.6.1.4.1.9.3.6.11.1.4','Slot card serial','Cisco','0','[^0]|\w{2,}','0',NULL,'OLD-CISCO-CHASSIS-MIB');

DELETE FROM snmpoid WHERE oidkey='cCardSlotNumber';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cCardSlotNumber','1.3.6.1.4.1.9.3.6.11.1.7','Slot card slotnumber mapping','Cisco','0',NULL,'0',NULL,'OLD-CISCO-CHASSIS-MIB');

DELETE FROM snmpoid WHERE oidkey='cCardSwVersion';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cCardSwVersion','1.3.6.1.4.1.9.3.6.11.1.6','Slot card software version','Cisco','0',NULL,'0',NULL,'OLD-CISCO-CHASSIS-MIB');
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cDescr','1.3.6.1.4.1.9.3.6.11.1.3','cgw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cHsrpGrpStandbyState';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cHsrpGrpStandbyState','1.3.6.1.4.1.9.9.106.1.2.1.1.15','cgw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cHsrpGrpVirtualIpAddr';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cHsrpGrpVirtualIpAddr','1.3.6.1.4.1.9.9.106.1.2.1.1.11','cgw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cHw';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cHw','1.3.6.1.4.1.9.3.6.11.1.5','cgw',NULL,'0',NULL,'0',NULL,NULL);
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cL3HwVer','1.3.6.1.4.1.9.9.92.1.1.1.4','Hardware version','cL3','0',NULL,'0',NULL,'CISCO-ENTITY-ASSET-MIB');

DELETE FROM snmpoid WHERE oidkey='cL3Model';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cL3Model','1.3.6.1.4.1.9.9.92.1.1.1.3','Model number','cL3','0',NULL,'0',NULL,'CISCO-ENTITY-ASSET-MIB');

DELETE FROM snmpoid WHERE oidkey='cL3Serial';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cL3Serial','1.3.6.1.4.1.9.9.92.1.1.1.2','Serial number','cL3','0',NULL,'0',NULL,'CISCO-ENTITY-ASSET-MIB');

DELETE FROM snmpoid WHERE oidkey='cL3SwVer';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cL3SwVer','1.3.6.1.4.1.9.9.92.1.1.1.8','Software version','cL3','0',NULL,'0',NULL,'CISCO-ENTITY-ASSET-MIB');

DELETE FROM snmpoid WHERE oidkey='cMenuDuplex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cMenuDuplex','1.3.6.1.4.1.9.5.14.4.1.1.5','Port duplex state','Cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cMenuIfIndex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cMenuIfIndex','1.3.6.1.4.1.9.5.14.4.1.1.4','Ifindex to port mapping','Cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cMenuMac';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cMenuMac','1.3.6.1.4.1.9.5.14.4.3.1.4.1','Bridge table for Cisco menu type switch','cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cMenuPortStatus';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cMenuPortStatus','1.3.6.1.4.1.9.5.14.4.1.1.29','Port state, up or down','Cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cMenuPortType';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cMenuPortType','1.3.6.1.4.1.9.5.14.4.1.1.41','Port type, media','Cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cMenuTrunk';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cMenuTrunk','1.3.6.1.4.1.9.5.14.4.1.1.44','Port trunk state','Cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cMenuVlan';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cMenuVlan','1.3.6.1.4.1.9.5.14.8.1.1.3','Port trunk state','Cisco','1',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cModel';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cModel','1.3.6.1.4.1.9.3.6.11.1.2','cgw',NULL,'0',NULL,'0',NULL,NULL);
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cSw','1.3.6.1.4.1.9.3.6.11.1.6','cgw',NULL,'0',NULL,'0',NULL,NULL);
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cdpNeighbour','1.3.6.1.4.1.9.9.23.1.2.1.1.6','CDP neighbour','cisco','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cdpRemoteIf';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cdpRemoteIf','1.3.6.1.4.1.9.9.23.1.2.1.1.7','CDP remote interface','cisco','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cpu1min';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cpu1min','1.3.6.1.4.1.9.2.1.57.0','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='cpu5min';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('cpu5min','1.3.6.1.4.1.9.2.1.58.0','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='dnscheck';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('dnscheck','1.3.6.1.2.1.1.5.0','Used by the DNSCheck plugin; is identical to sysname','mib-II','0',NULL,'1',NULL,NULL);
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifAdminStatus','1.3.6.1.2.1.2.2.1.7','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifAlias';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifAlias','1.3.6.1.2.1.31.1.1.1.18','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifDescr';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifDescr','1.3.6.1.2.1.2.2.1.2','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifHCInOctets';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifHCInOctets','1.3.6.1.2.1.31.1.1.1.6','Number of octets received on the interface','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifHCInUcastPkts';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifHCInUcastPkts','1.3.6.1.2.1.31.1.1.1.7','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifHCOutOctets';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifHCOutOctets','1.3.6.1.2.1.31.1.1.1.10','Number of octets transmitted out of the interface','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifHCOutUcastPkts';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifHCOutUcastPkts','1.3.6.1.2.1.31.1.1.1.11','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifInDiscards';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifInDiscards','1.3.6.1.2.1.2.2.1.13','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifInErrors';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifInErrors','1.3.6.1.2.1.2.2.1.14','Number of inbound packets that contained errors','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifInNUcastPkts';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifInNUcastPkts','1.3.6.1.2.1.2.2.1.12','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifInOctets';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifInOctets','1.3.6.1.2.1.2.2.1.10','Number of octets received on the interface','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifInUcastPkts';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifInUcastPkts','1.3.6.1.2.1.2.2.1.11','Packets which were not addressed to a multicast or broadcast address at this sub-layer','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifInUnknownProtos';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifInUnknownProtos','1.3.6.1.2.1.2.2.1.15','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifIndex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifIndex','1.3.6.1.2.1.2.2.1.1','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifLastChange';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifLastChange','1.3.6.1.2.1.2.2.1.9','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifMtu';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifMtu','1.3.6.1.2.1.2.2.1.4','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifName';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifName','1.3.6.1.2.1.31.1.1.1.1','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifNumber';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifNumber','1.3.6.1.2.1.2.1.0','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifOperStatus';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifOperStatus','1.3.6.1.2.1.2.2.1.8','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifOutDiscards';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifOutDiscards','1.3.6.1.2.1.2.2.1.19','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifOutErrors';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifOutErrors','1.3.6.1.2.1.2.2.1.20','Number of outbound packets that could not be transmitted because of errors','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifOutNUcastPkts';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifOutNUcastPkts','1.3.6.1.2.1.2.2.1.18','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifOutOctets';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifOutOctets','1.3.6.1.2.1.2.2.1.16','Number of octets transmitted out of the interface','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifOutQLen';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifOutQLen','1.3.6.1.2.1.2.2.1.21','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifOutUcastPkts';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifOutUcastPkts','1.3.6.1.2.1.2.2.1.17','Packets that higher-level protocols requested be transmitted, and which were not addressed to a multicast or broadcast address at this sub-layer','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifPhysAddress';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifPhysAddress','1.3.6.1.2.1.2.2.1.6','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifPortName';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifPortName','1.3.6.1.4.1.9.2.2.1.1.28','ios-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifSerial';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifSerial','1.3.6.1.2.1.47.1.1.1.1.11.1','standard',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifSpeed';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifSpeed','1.3.6.1.2.1.2.2.1.5','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifTrunk';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifTrunk','1.3.6.1.4.1.9.9.46.1.6.1.1.13','cL3-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifType';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifType','1.3.6.1.2.1.2.2.1.3','standard','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifVlan';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifVlan','1.3.6.1.4.1.9.9.68.1.2.2.1.2','ios-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ifVlansAllowed';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ifVlansAllowed','1.3.6.1.4.1.9.9.46.1.6.1.1.4','cL3-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='iosDuplex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('iosDuplex','1.3.6.1.4.1.9.9.87.1.4.1.1.32.0','ios-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='iosTrunk';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('iosTrunk','1.3.6.1.4.1.9.9.87.1.4.1.1.6.0','ios-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ipAdEntIfIndex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ipAdEntIfIndex','1.3.6.1.2.1.4.20.1.2','cgw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ipAdEntIfNetMask';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ipAdEntIfNetMask','1.3.6.1.2.1.4.20.1.3','cgw',NULL,'0',NULL,'0',NULL,NULL);
...
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('macPortEntry','1.3.6.1.2.1.17.4.3.1.2','Bridge table for various switches','bridge-mib','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='mem5minFree';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('mem5minFree','1.3.6.1.4.1.9.9.48.1.1.1.6.1','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='mem5minUsed';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('mem5minUsed','1.3.6.1.4.1.9.9.48.1.1.1.5.1','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='moduleMon';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('moduleMon','1.3.6.1.2.1.2.2.1.1','Used by the module monitor; is identical to ifIndex','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='ospfIfMetricMetric';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('ospfIfMetricMetric','1.3.6.1.2.1.14.8.1.4','cgw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='portDuplex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('portDuplex','1.3.6.1.4.1.9.5.1.4.1.1.10','cat-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='portIfIndex';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('portIfIndex','1.3.6.1.4.1.9.5.1.4.1.1.11','cat-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='portPortName';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('portPortName','1.3.6.1.4.1.9.5.1.4.1.1.4','cat-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='portTrunk';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('portTrunk','1.3.6.1.4.1.9.5.1.9.3.1.8','cat-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='portVlan';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('portVlan','1.3.6.1.4.1.9.5.1.9.3.1.3','cat-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='portVlansAllowed';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('portVlansAllowed','1.3.6.1.4.1.9.5.1.9.3.1.5','cat-sw',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='stpPortState';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('stpPortState','1.3.6.1.2.1.17.2.15.1.3','Spanning tree port state','bridge-mib','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='sysUpTime';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('sysUpTime','1.3.6.1.2.1.1.3.0','','mib-II','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='sysname';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('sysname','1.3.6.1.2.1.1.5.0','all',NULL,'0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='tempInlet';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('tempInlet','1.3.6.1.4.1.9.9.13.1.3.1.3.1','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='tempOutlet';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('tempOutlet','1.3.6.1.4.1.9.9.13.1.3.1.3.3','','Cricket','0',NULL,'0',NULL,NULL);

DELETE FROM snmpoid WHERE oidkey='typeoid';
INSERT INTO snmpoid (oidkey, snmpoid, descr, oidsource, getnext, match_regex, decodehex, oidname, mib)
VALUES ('typeoid','1.3.6.1.2.1.1.2.0','all',NULL,'0',NULL,'0',NULL,NULL);
