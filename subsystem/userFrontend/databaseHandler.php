...
FROM (SELECT id, navn, descr, true AS min
     ...
     (    SELECT count(tidsperiodeid) AS ap, utstyrgruppeid
            FROM (
                 SELECT DISTINCT ON (utstyrgruppeid) tidsperiodeid, utstyrgruppeid
...
#    print "<p>query: $querystring";
  ...
  // opprette ny profil
  function nyProfil($navn, $brukerid) {

    // Spxrring som legger inn i databasen
    $querystring = "INSERT INTO Brukerprofil (id, brukerid, navn) VALUES (" . 
