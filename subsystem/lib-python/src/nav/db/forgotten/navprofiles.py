"""Database wrappers.
Autogenerated by forgetSQL 2003-07-02.
"""
...
class Accountingroup(_Wrapper):
    _sqlFields =  {'account': 'accountid', 'group': 'groupid'}
    _sqlLinks =  {}
    _userClasses =  {'account': 'Account', 'group': 'Accountgroup'}
    _shortView =  ()
    _sqlTable =  'AccountInGroup'
    _descriptions =  {}
    _sqlPrimary = ('account', 'group')
