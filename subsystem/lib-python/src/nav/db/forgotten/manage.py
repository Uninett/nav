...
"""Database wrappers.
Autogenerated by forgetSQL 2003-09-16.
"""
...
class Gwport(_Wrapper):
    ...
    _sqlLinks =  {}
    _userClasses =  {'prefix': 'Prefix', 'module': 'Module'}
...
class Netboxdisk(_Wrapper):
    _sqlFields =  {'path': 'path', 'netbox': 'netboxid', 'blocksize': 'blocksize'}
    _sqlLinks =  {}
    _userClasses =  {'netbox': 'Netbox'}
    _shortView =  ()
    _sqlTable =  'netboxdisk'
    _descriptions =  {}

class Netboxinfo(_Wrapper):
    _sqlFields =  {'var': 'var', 'netbox': 'netboxid', 'val': 'val', 'key': 'key'}
    _sqlLinks =  {}
    _userClasses =  {'netbox': 'Netbox'}
    _shortView =  ()
...
class Netboxinterface(_Wrapper):
    _sqlFields =  {'interf': 'interf', 'netbox': 'netboxid'}
    _sqlLinks =  {}
    _userClasses =  {'netbox': 'Netbox'}
    _shortView =  ()
    _sqlTable =  'netboxinterface'
    _descriptions =  {}
...
class Prefix(_Wrapper):
    _sqlFields =  {'active_ip_cnt': 'active_ip_cnt',
                  'max_ip_cnt': 'max_ip_cnt',
                  'netaddr': 'netaddr',
                  'prefixid': 'prefixid',
                  'rootgwid': 'rootgwid',
                  'to_gw': 'to_gw',
...
class Type(_Wrapper):
    _sqlFields =  {'cdp': 'cdp',
                  ...
                  'vendor': 'vendorid'}
    _sqlLinks =  {}
    _userClasses =  {'typegroup': 'Typegroup', 'vendor': 'Vendor'}
    _sqlPrimary =  ('typeid',)
    _shortView =  ()
    _sqlTable =  'type'
    _descriptions =  {}
