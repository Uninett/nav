...
urlpatterns = patterns('',
    ...
    url(r'^filters/add-expression/$', filter_addexpresion,
        name='alertprofiles-filters-addexpresion'),
    url(r'^filters/save-expression/$', filter_saveexpresion,
        name='alertprofiles-filters-saveexpresion'),
    url(r'^filters/remove-expression/$', filter_removeexpresion,
