...
UPDATE snmpoid SET unit = 'octets' WHERE oidkey = 'ipIfStatsHCInOctets.ipv6';
UPDATE snmpoid SET unit = 'octets' WHERE oidkey = 'ipIfStatsHCInOctets.ipv4';
UPDATE snmpoid SET unit = 'octets' WHERE oidkey = 'ifHCInOctets';
UPDATE snmpoid SET unit = 'packets' WHERE oidkey = 'ifHCInUcastPkts';
UPDATE snmpoid SET unit = 'octets' WHERE oidkey = 'ifHCOutOctets';
...
UPDATE snmpoid SET unit = 'octets' WHERE oidkey = 'ifInOctets';
...
UPDATE snmpoid SET unit = 'octets' WHERE oidkey = 'ifOutOctets';
