...
UPDATE room SET data = ('opt1' => opt1) WHERE COALESCE(opt1, '') <> '';
UPDATE room SET data = data || ('opt2' => opt2) WHERE COALESCE(opt2, '') <> '';
UPDATE room SET data = data || ('opt3' => opt3) WHERE COALESCE(opt3, '') <> '';
UPDATE room SET data = data || ('opt4' => opt4) WHERE COALESCE(opt4, '') <> '';
