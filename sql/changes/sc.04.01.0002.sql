...
UPDATE org SET data = ('opt1' => opt1) WHERE COALESCE(opt1, '') <> '';
UPDATE org SET data = data || ('opt2' => opt2) WHERE COALESCE(opt2, '') <> '';
UPDATE org SET data = data || ('opt3' => opt3) WHERE COALESCE(opt3, '') <> '';
