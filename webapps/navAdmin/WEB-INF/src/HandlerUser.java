	...
	public String begin() throws PError
	{
		...
		************************************************************/
		...
		if (s.length >= 2)
		{
			...
			if (s[1].equals("fornavn"))
			{
				fornavn();
			} else
			if (s[1].equals("etternavn"))
			{
				etternavn();
			} else
			if (s[1].equals("email"))
			...
			if (s[1].equals("adresse"))
			{
				adresse();
			} else
			if (s[1].equals("postnr"))
			{
				postnr();
			} else
			if (s[1].equals("postby"))
			{
				postby();
			} else
			if (s[1].equals("telefon"))
			{
				telefon();
			} else
			if (s[1].equals("mobil"))
...
*/
	...
	private void navn()
	{
		...
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select navn from users where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	 ...
	 * Viser fornavn
	 */
	private void fornavn()
	{
		if (com.doauth() )
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select first from personalia where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	 ...
	 * Viser etternavn
	 */
	private void etternavn()
	{
		if (com.doauth() )
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select last from personalia where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	...
	private void email()
	{
		...
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select email from users where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	...
	private void adresse()
	{
		...
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select adresse from personalia where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	...
	private void postnr()
	{
		...
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select postnr from personalia where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	...
	private void postby()
	{
		...
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select postby from personalia where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	...
	private void telefon()
	{
		...
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select telefon from personalia where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	...
	private void mobil()
	{
		...
		{
			String user = com.getUser().getLogin();
			String[] info = db.exec("select mobil from personalia where login='" + user + "';");
			if (info[0] != null)
			{
				com.out(info[0]);
			}
	...
	private void mailpw()
	{
		String login = com.getReq().getParameter("loginMailPw");
		String pw = misc.getRandomPw();

		if (login != null)
		{
			login = misc.encSql(login);
			String[] info = db.exec("select email from users where login='" + login + "';");
			...
			if (info[0] != null)
			{
				if (info[0].length() >= 6)
				{
					...
					//mail.sendmail(info[0], "admin@dataparty.no", subject, body.toString(), com);
					//mail.sendmail(info[0], "kreide@online.no", subject, "her kommer passord", com);

					//String[] cpw = db.exec("select PASSWORD('" + pw + "');");
					db.exec("update users set pw=PASSWORD('" + pw + "') where login='" + login + "';");
	...
	************************************************************/
	...
	private void info()
	{
		...
		user = misc.encSql(user);

		String[] info = db.exec("select login from users where login='" + user + "';");
		if (info[0] != null)
		{
			com.out(info[0]);
		}
