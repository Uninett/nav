...
class HandlerMain
{
	...
	************************************************************/
	 ...
	 * Viser aktivt party
	 */
	private void aktivtParty()
	{
		String[] party = db.exec("select value from config where name='activeParty';");

		if (party[0] != null)
		{
			com.out(misc.encSql(party[0]));
		}
	}
