...
class TestValidateDashboardData:
    ...
    def test_when_name_is_empty_then_it_should_raise_value_error(self):
        data = _make_dashboard_data(name="")
        with pytest.raises(ValueError, match="must not be empty"):
            validate_dashboard_data(data)

    def test_when_name_is_whitespace_only_then_it_should_raise_value_error(self):
        data = _make_dashboard_data(name="   ")
        with pytest.raises(ValueError, match="must not be empty"):
            validate_dashboard_data(data)
