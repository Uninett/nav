...
def valid_dhcp4():
    ...
    expected_stats = [
        ...
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-staff.42_0_1_1.42_0_1_10.declined",
            ("2025-05-30 05:49:49.467993", 1),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-staff.42_0_1_1.42_0_1_10.total",
            ("2025-05-30 05:49:49.467993", 10),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_1.42_0_2_10.assigned",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_1.42_0_2_10.declined",
            ("2025-05-30 05:49:49.467993", 1),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_1.42_0_2_10.total",
            ("2025-05-30 05:49:49.467993", 10),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_128.42_0_2_255.assigned",
            ("2025-05-30 05:49:49.467993", 1),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_128.42_0_2_255.declined",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_128.42_0_2_255.total",
            ("2025-05-30 05:49:49.467993", 128),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_32.42_0_2_47.assigned",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_32.42_0_2_47.declined",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.bergen-student.42_0_2_32.42_0_2_47.total",
            ("2025-05-30 05:49:49.467993", 16),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.oslo-student.42_0_3_1.42_0_3_10.assigned",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.oslo-student.42_0_3_1.42_0_3_10.declined",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.oslo-student.42_0_3_1.42_0_3_10.total",
            ("2025-05-30 05:49:49.467993", 10),
        ),
        (
            # From Kea pool with 'group': 'oslo-staff' in 'user-context'
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.oslo-staff.42_0_4_1.42_0_4_5.assigned",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            # From Kea pool with 'group': 'oslo-staff' in 'user-context'
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.oslo-staff.42_0_4_1.42_0_4_5.declined",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            # From Kea pool with 'group': 'oslo-staff' in 'user-context'
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.custom_groups.oslo-staff.42_0_4_1.42_0_4_5.total",
            ("2025-05-30 05:49:49.467993", 5),
        ),
        (
            # From Kea pool without 'user-context'
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.special_groups.standalone.42_0_5_1.42_0_5_5.assigned",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            # From Kea pool without 'user-context'
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.special_groups.standalone.42_0_5_1.42_0_5_5.declined",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            # From Kea pool without 'user-context'
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.special_groups.standalone.42_0_5_1.42_0_5_5.total",
            ("2025-05-30 05:49:49.467993", 5),
        ),
        (
        ...
        (
            # From Kea pool with 'user-context' but without 'group' in 'user-context'
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.special_groups.standalone.42_0_6_1.42_0_6_5.declined",
            ("2025-05-30 05:49:49.467993", 0),
        ),
        (
            # From Kea pool with 'user-context' but without 'group' in 'user-context'
            f"nav.dhcp.4.{SERVER_NICKNAME}.range.special_groups.standalone.42_0_6_1.42_0_6_5.total",
            ("2025-05-30 05:49:49.467993", 5),
        ),
    ]
