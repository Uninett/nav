...
class TestAuthorizationMiddleware(object):
    def test_path_if_explicit_login_required_should_call_authorize_request_and_return_None(  # noqa: E501
        self,
    ):
        # Golden path!
    ...
    def test_if_explicit_login_required_and_not_authorized_should_call_redirect_to_login(  # noqa: E501
        self,
    ):
        viewfunc = lambda request: None
        r = RequestFactory()
    ...
    def test_if_not_explicit_login_required_should_return_None(self):
        viewfunc = lambda request: None
...
class TestRedirectToLogin:
    ...
    def test_golden_path_returns_HttpResponseRedirect(self):
    ...
    def test_with_ajax_returns_401_response(self):
