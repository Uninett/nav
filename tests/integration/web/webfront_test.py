...
class TestImportDashboardViews:
    ...
    def test_given_a_valid_dashboard_file_then_create_dashboard(
        ...
        assert dashboard.num_columns == 3
    ...
    def test_given_dashboard_file_with_wrong_file_type_then_return_error(self, client):
        """Tests that incorrect field types return an error"""
        dashboard_data = {
            'name': 'Test Dashboard',
