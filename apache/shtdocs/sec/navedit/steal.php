...
if($ok){
  ...
  $tekst = "<p>".path_file($file)."</p><p>Are you really sure you want to steal this file from <b>".locked_nrs($file)."</b>?</p>$buttons";
...
print "<div id=\"content\"><h1>Steal file</h1>$innhold</div>";
