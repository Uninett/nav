<HTML>
 ...
 <BODY bgcolor="#FFFFFF">
  <APPLET
   ...
   >
   <PARAM NAME="vPServerURL" VALUE="http://www.nav.ntnu.no/vPServerNG/servlet/vPServer">
   <PARAM NAME="lastURL" VALUE="http://www.nav.ntnu.no/vlanPlotNG/common/vPLast/last_ny.pl">
