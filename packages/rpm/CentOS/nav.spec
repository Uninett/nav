...
%config(noreplace) %{_prefix}/etc/sortedStats.conf
...
%config(noreplace) %{_prefix}/etc/arnold/mailtemplates/README
...
%changelog
* Mon Nov 13 2006  <kaa@msu.net>

- Grabbed new version 3.1.1
