...
from nav.web.netmapdev.views import demo, d3js_layer2, graphml_layer2, index, \
    ...
    save_new_view, get_views, test_traffic_foo, get_netmaps, get_netmap

# The patterns are relative to the base URL of the subsystem
urlpatterns = patterns('nav.web.netmapdev.views',
    url(r'^$', index, name='netmapdev-index'),
    url(r'^api/netmap$', get_netmaps,
        name='netmapdev-api-netmap'),
    url(r'^api/netmap/(?P<view_id>[\d]+)$', get_netmap,
        name='netmapdev-api-netmap'),
    url(r'^api/graph$', d3js_layer2,
        name='netmapdev-api-netmap'),
    url(r'^api/graph/(?P<view_id>[\d]+)$', d3js_layer2,
        name='netmapdev-api-netmap'),
