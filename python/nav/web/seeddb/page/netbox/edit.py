...
from nav.web.seeddb.page.netbox.forms import NetboxSerialForm, NetboxModelForm
...
def netbox_edit2(request, netbox_id=None):
    netbox = None
    if netbox_id:
...
def get_sysname(ip_address):
    ...
    try:
        ip, sysname = resolve_ip_and_sysname(ip_address)
        return sysname
    except SocketError:
        return None
