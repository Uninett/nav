...
class NetboxModelForm(forms.ModelForm):
    ...
    class Meta(object):
        ...
        fields = ['ip', 'room', 'category', 'organization',
                  ...
                  'virtual_instance', 'readonly_connection_profile',
                  'readwrite_connection_profile']
        help_texts = {
        ...
        self.helper.layout = Layout(
            Row(
                Column(
                    ...
                    css_class=css_class),
                Column(
                    Fieldset('Connection Profiles',
                             'readonly_connection_profile',
                             'readwrite_connection_profile',
    ...
    def clean(self):
        ...
        ro_profile = cleaned_data.get('readonly_connection_profile')
        ...
        if cat and cat.req_snmp and not ro_profile:
