...
urlpatterns = [
    ...
    url(r'^netbox/delete/(?P<object_id>(\d+))/',
    ...
    url(r'^netbox/add/$',
        netbox_edit.netbox_edit,
        name='seeddb-netbox-edit'),
    url(r'^netbox/(?P<action>copy)/(?P<netbox_id>(\d+))/',
        netbox_edit.netbox_edit,
    ...
    url(r'^management-profile/delete/(?P<object_id>.+)/$',
        management_profile_delete,
    ...
    url(r'^service/delete/(?P<object_id>[\d]+)$',
    ...
    url(r'^room/delete/(?P<object_id>.+)/$',
        room.room_delete,
        name='seeddb-room-delete'),
    url(r'^room/(?P<action>copy)/(?P<room_id>.+)/$',
        room.room_edit,
    ...
    url(r'^location/delete/(?P<object_id>.+)/$',
        location.location_delete,
        name='seeddb-location-delete'),
    url(r'^location/add/$',
        location.location_edit,
        name='seeddb-location-edit'),
    url(r'^location/(?P<action>copy)/(?P<location_id>.+)/$',
        location.location_edit,
    ...
    url(r'^organization/delete/(?P<object_id>.+)/$',
    ...
    url(r'^usage/delete/(?P<object_id>.+)/$',
        usage.usage_delete,
    ...
    url(r'^type/delete/(?P<object_id>[\d]+)/$',
    ...
    url(r'^netboxgroup/delete/(?P<object_id>.+)/$',
    ...
    url(r'^prefix/delete/(?P<object_id>[\d]+)/$',
    ...
    url(r'^cabling/delete/(?P<object_id>[\d]+)/$',
