...
def populate_infodict(request, netbox, interfaces):
    ...
    readonly, handler = _initialize_handler_and_readonly_state(
...
def _initialize_handler_and_readonly_state(request, netbox, interfaces):
    """Initialize management handler and determine readonly state"""
    readonly = False
    handler = None
