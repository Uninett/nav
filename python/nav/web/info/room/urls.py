...
urlpatterns = patterns('',
    ...
    url(r'^image/update_title', views.update_title,
        name='room-info-update-title'),
    url(r'^image/delete', views.delete_image,
        name='room-info-delete-image'),
    url(r'^image/update_priority', views.update_priority,
        name='room-info-update-priority'),
    url(r'^(?P<roomid>.+)/upload/', views.upload_image,
        name='room-info-upload'),
    url(r'^(?P<roomid>.+)/sensors/', views.render_sensors,
        name='room-info-sensors'),
    url(r'^(?P<roomid>.+)/racks/add_rack', views.add_rack,
        name='room-info-racks-add-rack'),
    url(r'^(?P<roomid>.+)/racks/(?P<rackid>\d+)/rename_rack', views.rename_rack,
        name='room-info-racks-rename-rack'),
    url(r'^(?P<roomid>.+)/racks/remove_rack', views.remove_rack,
        name='room-info-racks-remove-rack'),
    url(r'^(?P<roomid>.+)/racks/add_sensor', views.render_add_sensor,
        name='room-info-racks-add-sensor'),
    url(r'^(?P<roomid>.+)/racks/remove_sensor', views.remove_sensor,
        name='room-info-racks-remove-sensor'),
    url(r'^(?P<roomid>.+)/racks/save_sensor_order', views.save_sensor_order,
        name='room-info-racks-save-sensor-order'),
    url(r'^(?P<roomid>.+)/racks/save_rack_order', views.save_rack_order,
        name='room-info-racks-save-rack-order'),
    url(r'^(?P<roomid>.+)/racks/save_rack_color', views.save_rack_color,
