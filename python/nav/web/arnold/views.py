...
def render_search(request):
    ...
    return render(request, 'arnold/search.html',
                  create_context('Search', { 'form': form, 'search_result':
                                            search_result, 'active': {'search':
                                                                      True} }))
...
def render_manual_detention_step_one(request):
    ...
    return render(
        ...
        create_context('Manual detention', { 'active': {'manualdetention':
                                                        True}, 'form': form,
                                            'error': error }))
...
def render_manual_detention_step_two(request, target):
    ...
    return render(
        ...
        create_context('Manual detention', 
                       { 'active': {'manualdetention': True}, 'target': target,
                        'candidates': candidates, 'form': form, 
                        'now': datetime.now(), 'error': error }))
...
def choose_detentions(request, did):
    ...
    return render(request, 'arnold/choose_detentions.html',
