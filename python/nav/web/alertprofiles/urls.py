...
urlpatterns = [
    ...
    url(r'^profile/remove/$',
        views.profile_remove,
    ...
    url(r'^address/remove/$',
        views.address_remove,
    ...
    url(r'^permissions/(?P<group_id>\d+)/$',
        views.permission_list,
        name='alertprofiles-permissions-detail'),
    url(r'^permissions/save/$',
