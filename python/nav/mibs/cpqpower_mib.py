...
SENSORS = [
{
    ...
    'filter': lambda x: x.get('pdu3GroupName') is not None and x.get('pdu3GroupVoltageMeasType'),
    'sensors': {
        'pdu3GroupVoltage': {
        ...
        'pdu3GroupCurrent': {
            ...
            if x.get('pdu3groupCurrentRating') > 0 else None,
        },
        'pdu3GroupPowerVA': {
...
},
{
    ...
    'sensors': {
        ...
        'pdu3InputPhaseCurrent': {
            ...
            if x.get('pdu3InputPhaseCurrentRating') > 0 else None,
        },
