 ...
 * the canHandleDevice() method with the device description object, Netbox, as parameter.
...
{
	/**
	 * The value 0, which means this plugin cannot handle the given Netbox.
	 */
	public static final int NEVER_HANDLE = 0;

	/**
	 * Special value saying that this plugin should always handle the device,
	 * but its order among the plugins is not important.
	 */
	 ...
	 * by the Netbox argument, and return a value different from zero if it does; this
	 * will typically be ALWAYS_HANDLE if the plugin does not have any special needs.
	 * </p>
	 *
	 * <p>
