define(['plugins/date_utils', 'libs/jquery'], function (DateUtils) {
    describe("DateUtils", function () {
        ...
        it("zeropad should pad single number", function() {
        ...
        it.skip("//time since should return correct future", function() {
